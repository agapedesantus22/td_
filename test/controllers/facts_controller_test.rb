...
class FactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post facts_url, params: { fact: { post: @fact.post, title: @fact.title, user_id: @fact.user_id } }
    end
  ...
  test "should update fact" do
    patch fact_url(@fact), params: { fact: { post: @fact.post, title: @fact.title, user_id: @fact.user_id } }
